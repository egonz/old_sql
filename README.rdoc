...
* Reports can be created using little or no Ruby code.
  This allows the SQL for the report to be designed by a DBA, or other database developer
  independent of Ruby.
  Reports can be designed using a design file that mocks the reports. This file can contain
  data from the SQL, as well as String literals, and formulas (that can also use numeric literals).
...
Configure your reports config/old_sql/report.yml. An example confiiguration is created when you run the old_sql:install generator.
